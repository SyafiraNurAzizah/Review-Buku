...
<?php
  ...
  <?php } ?>
        ...
        <a  href="region-local.php"><button class="local">LOCAL</button></a>
        <a><button class="universal">UNIVERSAL</button></a>
...
<div class="bagianbuku">
        ...
        <div class="card">
          <div class="title">
            ...
            <a href="reviewPage_universal.php?id=<?= $row['id'] ?>" class="aliran"><h2><?= $row["JUDUL"];?></h2></a>
