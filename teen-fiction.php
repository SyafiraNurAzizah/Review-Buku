...
$result = mysqli_query($conn,'SELECT * FROM teenfiction');
...
<nav>
      ...
      <?php
        ...
        <a href="horor.php"><button class="horor">HOROR</button></a>
        ...
        <a><button class="teen-fiction">TEEN-FICTION</button></a>
...
<div class="bagianbuku">
        ...
        <div class="card">
          <div class="title">
            ...
            <a href="reviewPage_teenfiction.php?id=<?= $row['id'] ?>" class="aliran"><h2><?= $row["JUDUL"];?></h2></a>
