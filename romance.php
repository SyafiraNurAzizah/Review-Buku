...
$result = mysqli_query($conn,'SELECT * FROM romance');
...
<nav>
      ...
      <?php
        ...
        <a ><button class="romance">ROMANCE</button></a>
...
<div class="bagianbuku">
        ...
        <div class="card">
          <div class="title">
            ...
            <a href="reviewPage_romance.php?id=<?= $row['id'] ?>" class="aliran"><h2><?= $row["JUDUL"];?></h2></a>
