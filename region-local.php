...
<div class="container">
  <ul>
    <a>
      ...
      <li><a href="region-local.php" class="region">Region</a></li>
    </a>
  </ul>
...
<?php
  ...
  <?php } ?>
        ...
        <a><button class="local">LOCAL</button></a>
        <a href="region-universal.php"><button class="universal">UNIVERSAL</button></a>
...
<div class="bagianbuku">
        ...
        <div class="card">
          <div class="title">
            ...
            <a href="reviewPage_local.php?id=<?= $row['id'] ?>" class="aliran"><h2><?= $row["JUDUL"];?></h2></a>
