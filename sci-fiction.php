...
$result = mysqli_query($conn,'SELECT * FROM scifiction');
...
<nav>
      ...
      <?php
        ...
        <a ><button class="sci-fiction">SCI-FICTION</button></a>
...
<div class="bagianbuku">
        ...
        <div class="card">
          <div class="title">
            ...
            <a href="reviewPage_scifiction.php?id=<?= $row['id'] ?>" class="aliran"><h2><?= $row["JUDUL"];?></h2></a>
