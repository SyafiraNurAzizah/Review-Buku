...
$result = mysqli_query($conn,'SELECT * FROM fantasi');
...
<nav>
      ...
      <?php
        ...
        <a><button class="fantasi">FANTASI</button></a>
...
<div class="bagianbuku">
        ...
        <div class="card">
          <div class="title">
            ...
            <a href="reviewPage_fantasi.php?id=<?= $row['id'] ?>" class="aliran"><h2><?= $row["JUDUL"];?></h2></a>
