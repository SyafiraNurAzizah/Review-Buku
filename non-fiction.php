...
$result = mysqli_query($conn,'SELECT * FROM nonfiction');
...
<nav>
      ...
      <?php
        ...
        <a ><button class="non-fiction">NON-FICTION</button></a>
...
<div class="bagianbuku">
        ...
        <div class="card">
          <div class="title">
            ...
            <a href="reviewPage_nonfiction.php?id=<?= $row['id'] ?>" class="aliran"><h2><?= $row["JUDUL"];?></h2></a>
